...
ACLOCAL = ${SHELL} /Users/Asher/Dropbox/Development/Workspace/Dynamic-MOTD-CPP/missing aclocal-1.14
ALL_LINGUAS = 
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /Users/Asher/Dropbox/Development/Workspace/Dynamic-MOTD-CPP/missing automake-1.14
AWK = gawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
